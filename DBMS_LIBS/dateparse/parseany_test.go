...
func TestWaf(t *testing.T) {
	ddd, err := ParseAny("29/Apr/2019:10:17:19 +0800")
	if err != nil {
		fmt.Printf("29/Apr/2019:10:17:19 +0800 parse err:%v\n", err)
		//t.Errorf("29/Apr/2019:10:17:19 +0800 parse err:%v", err)
	}
	fmt.Printf("29/Apr/2019:10:17:19 +0800 parse :%v===========\nn", ddd)

	ddd, err = time.Parse("02/Jan/2006:15:04:05 -0700", "29/Apr/2019:10:17:19 +0800")
	if err != nil {
		fmt.Printf("29/Apr/2019:10:17:19 +0800 time.parse err:%v\n", err)
		//t.Errorf("29/Apr/2019:10:17:19 +0800 parse err:%v", err)
	}
	fmt.Printf("29/Apr/2019:10:17:19 +0800 time.parse :=%v=\n", ddd)
}
